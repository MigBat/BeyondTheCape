...
NDiplomacy = {
	...
	KNOWLEDGE_SHARING_INSTITUTION_GROWTH_MONTHLY = 0.2,
	KNOWLEDGE_SHARING_DURATION_YEARS = 10,
	KNOWLEDGE_SHARING_COST_PERCENT_MONTHLY = 20.0,
...
NCountry = {
	...
	INSTITUTION_BASE_IMP_DEVELOPMENT = 0,
	...
	MINIMUM_ADVISOR_DURATION = 18, 					-- _CDEF_MINIMUM_ADVISOR_DURATION_
	-- BEYOND THE CAPE CHANGE
	MINIMUM_ADVISOR_DURATION_CHANCE_VALUE = 17,		-- Higher value here gives lower daily death chance after MINIMUM_ADVISOR_DURATION
...
NEconomy = {
	...
	TRADE_WIND_STRENGTH = 1.0,						-- _EDEF_TRADE_WIND_STRENGTH_
